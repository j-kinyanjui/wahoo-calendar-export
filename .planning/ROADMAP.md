...
|-------|------|--------------|
| 1 - Auth & Fetch | User can input JWT token and fetch training plans via GraphQL | AUTH-01, AUTH-02, AUTH-03, DATA-01, DATA-02, DATA-03, DATA-04 |
...
**Goal:** User can input JWT token and application can fetch training plans via GraphQL
...
1. User can enter Systm JWT token via web form and submit
